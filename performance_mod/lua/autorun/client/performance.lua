...
CreateClientConVar(	 "performancemod_enabled", 1,  true, false)
CreateClientConVar(	 "performancemod_network_enabled", 1,  true, false)
CreateClientConVar(	 "performancemod_other_enabled", 1,  true, false)
hook.Add( "PopulateToolMenu", "Performance_toolmenu", function()
    spawnmenu.AddToolMenuOption( "Utilities", "User", "Performance Mod", "Performance Mod", "", "", function( panel )
        panel:CheckBox( "Enable FPS Boost", "performancemod_enabled", 0, 1 )
        panel:ControlHelp( "This will utilizes more CPU resources." )
        panel:CheckBox( "Enable Network Optimization", "performancemod_network_enabled", 0, 1 )
        panel:ControlHelp( "This can eliminates packet loss." )
        panel:CheckBox( "Enable Other Optimization", "performancemod_other_enabled", 0, 1 )
        panel:ControlHelp( "This will optimizes sound system and file system." )
        panel:ControlHelp( " " )
        panel:ControlHelp( "Restart to apply changes." )
    end )
end )

if(GetConVar( "performancemod_enabled" ):GetFloat() == 0 ) then
...
if(GetConVar( "performancemod_network_enabled" ):GetFloat() == 0 ) then
...
if(GetConVar( "performancemod_other_enabled" ):GetFloat() == 0 ) then
